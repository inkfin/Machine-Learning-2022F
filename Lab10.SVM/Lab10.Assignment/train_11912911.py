...
def processFiles(pos_dir, neg_dir, recurse=False, output_file=False,
    ...
    # Solve the '.DS_Store' problem in MacOS
    pos_files = [file for file in pos_files if '.DS_Store' not in file]
    neg_files = [file for file in neg_files if '.DS_Store' not in file]
